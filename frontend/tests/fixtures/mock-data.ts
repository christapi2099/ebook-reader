export const MOCK_SENTENCES = [
  { index: 0, text: 'Sentence 0.', page: 0, x0: 50, y0: 100, x1: 400, y1: 120, filtered: false, words: [{ x0:50, y0:100, x1:150, y1:120 }, { x0:155, y0:100, x1:300, y1:120 }] },
  { index: 1, text: 'Sentence 1.', page: 0, x0: 50, y0: 130, x1: 400, y1: 150, filtered: false, words: [{ x0:50, y0:130, x1:200, y1:150 }] },
  { index: 2, text: 'Sentence 2.', page: 0, x0: 50, y0: 160, x1: 400, y1: 180, filtered: false, words: [] },
  { index: 3, text: 'Sentence 3.', page: 1, x0: 50, y0: 50, x1: 400, y1: 70, filtered: false, words: [] },
  { index: 4, text: 'Sentence 4.', page: 1, x0: 50, y0: 80, x1: 400, y1: 100, filtered: false, words: [] },
  { index: 5, text: 'Sentence 5.', page: 1, x0: 50, y0: 110, x1: 400, y1: 130, filtered: false, words: [] },
]
